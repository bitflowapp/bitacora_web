...
void main() {
  test('normalize adds scheme and trims trailing slash', () {
    expect(EngineConfig.normalize('example.com/'), 'http://example.com');
    expect(EngineConfig.normalize('https://host.tld///'), 'https://host.tld');
    expect(EngineConfig.normalize('  http://foo  '), 'http://foo');
  });

  test('isValidBaseUrl validates http/https and host', () {
