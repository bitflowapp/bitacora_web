...
class MailReportService {
  MailReportService._({CloudMailer? mailer}) : _mailer = mailer ?? CloudMailer.I;
  ...
  Future<void> sendReport({
    ...
    xlsxBytes is Uint8List ? (xlsxBytes as Uint8List) : Uint8List.fromList(xlsxBytes);
    ...
    final String metaLine = _buildMetaLine(sheetId: sheetId, deviceInfo: deviceInfo);

    final String finalText = metaLine.isEmpty ? safeMessage : '$safeMessage\n\n$metaLine';
