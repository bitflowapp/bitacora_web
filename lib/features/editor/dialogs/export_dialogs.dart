                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      switch (format) {
                        'zip' =>
                          'Paquete recomendado para enviar: un solo ZIP con Excel, PDF y evidencias.',
                        'pdf' =>
                          'Reporte listo para clientes: resumen ejecutivo, tabla y evidencias.',
                        _ =>
                          'Archivo Excel editable para trabajo interno y seguimiento.',
                      },
                      style: Theme.of(context).textTheme.bodySmall,
                    ),
                    if (_rows.isEmpty) ...[
