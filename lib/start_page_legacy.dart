...
class StartPageLegacy extends StatefulWidget {
  const StartPageLegacy({
    super.key,
  ...
  @override
  State<StartPageLegacy> createState() => _StartPageState();
}
...
class _StartPageState extends State<StartPageLegacy> {
