...
class GpsMeta {
  ...
  static GpsMeta? fromJson(Object? raw) {
    ...
    return GpsMeta(
      ...
      timestamp: DateTime.tryParse((raw['ts'] ?? '').toString()) ??
          DateTime.now(),
...
class PhotoAttachment {
  ...
  static PhotoAttachment? fromJson(Object? raw) {
    if (raw is! Map) return null;
  ...
  PhotoAttachment copy() => PhotoAttachment(
        id: id,
        filename: filename,
        mime: mime,
        size: size,
  ...
  static CellMeta? fromJson(Object? raw) {
    ...
    if (photosRaw is List) {
      for (final p in photosRaw) {
        final item = PhotoAttachment.fromJson(p);
