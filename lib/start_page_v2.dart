...
class _StartPageState extends State<StartPageV2> {
  ...
  static const List<_PackTemplateSpec> _commercialTemplates =
    ...
    _PackTemplateSpec(
      ...
      columns: <_PackColumnSpec>[
        ...
        _PackColumnSpec(label: 'ObservaciÃ³n', type: 'text'),
      ],
      views: <_PackViewPreset>[
        _PackViewPreset(name: 'Campo'),
        _PackViewPreset(name: 'RevisiÃ³n', statusValue: 'Pendiente'),
        _PackViewPreset(name: 'Urgentes', statusValue: 'Urgente'),
      ],
    ),
    _PackTemplateSpec(
      id: 'campo_mantenimiento_rapido',
      pack: 'Campo/InspecciÃ³n',
      name: 'Mantenimiento rÃ¡pido',
      description: 'Tareas de mantenimiento con prÃ³xima fecha.',
      ...
      columns: <_PackColumnSpec>[
        ...
        _PackColumnSpec(label: 'PrÃ³xima fecha', type: 'date'),
        _PackColumnSpec(label: 'ObservaciÃ³n', type: 'text'),
      ],
      views: <_PackViewPreset>[
        _PackViewPreset(name: 'Campo'),
    ...
    _PackTemplateSpec(
      ...
      views: <_PackViewPreset>[
        _PackViewPreset(name: 'Campo'),
        _PackViewPreset(name: 'RevisiÃ³n', statusValue: 'Revisar'),
        _PackViewPreset(name: 'Urgentes', statusValue: 'Urgente'),
      ],
    ),
    _PackTemplateSpec(
    ...
    try {
      ...
      if (outcome == ExportFlowOutcome.unsupported) {
        _reportStartPageErrorMessage(
          ...
          fallbackMessage:
              'La exportaciÃ³n XLSX desde Inicio no estÃ¡ disponible en este dispositivo. AbrÃ­ la planilla y exportÃ¡ ZIP/PDF desde el editor.',
        );
        return;
      }
      if (!mounted) return;
      _reportStartPageError(
        ...
        operation: 'export_sheet_xlsx',
        fallbackMessage:
            'No pudimos exportar la planilla. IntentÃ¡ nuevamente o usÃ¡ exportaciÃ³n desde el editor.',
        stackTrace: st,
      );
    } finally {
      _endBusyOperation();
  ...
  Future<void> _editNote(SheetMeta m) async {
    ...
    final result = await _promptMultilineCupertino(
      ...
      placeholder: 'Ej: Enviar a cliente hoy 18:00 / WP: revisar mediciÃ³n 3',
      okText: 'Guardar',
  ...
  Future<void> _deleteFolderFlow(BuildContext ctx, _Folder folder) async {
    final ok = await _confirmCupertino(
      ...
      message: 'Las planillas vuelven a RaÃ­z. Eliminar ${folder.name}?',
      okText: 'Eliminar',
      danger: true,
    );
  ...
  _StartNotice? _buildPriorityNotice() {
    ...
    if (kIsWeb && WebCapabilities.isInAppBrowser) {
      return _StartNotice(
        ...
        detailsBody:
            'Los navegadores embebidos bloquean cÃ¡mara, micrÃ³fono, GPS y guardado local. Abre BitFlow en Safari o Chrome para operar sin fricciÃ³n.',
    ...
    if (_shouldShowIosInstallHelper) {
      return _StartNotice(
        message: 'Instala BitFlow en Safari para acceso rÃ¡pido.',
        actionLabel: 'Entendido',
        detailsTitle: 'Instalar en iPhone',
        detailsBody:
            'Desde Safari: Compartir -> AÃ±adir a pantalla de inicio. AsÃ­ se abre como app y evita pasos extra.',
    ...
    if (RuntimeFlags.demoMode && _demoModeEnabled) {
      return _StartNotice(
        ...
        detailsBody:
            'La demo muestra valor rÃ¡pido sin tocar datos reales. Puedes activarla de nuevo cuando quieras.',
  ...
  Future<void> _openSupportChannel() async {
    ...
    if (!opened && mounted) {
      _toast(
          'No se pudo abrir soporte. EscrÃ­benos a $_supportEmailOrDefault.');
    }
  }
  ...
  Future<void> _openMoreSheet(_ApplePalette colors) async {
    final items = <_MoreSheetItem>[
      ...
      _MoreSheetItem(
        ...
        subtitle: 'VersiÃ³n, build y estado de la app',
      ...
      _MoreSheetItem(
        ...
        title: 'Carpetas',
        subtitle: 'Organiza planillas por Ã¡reas o clientes',
        onSelected: _openFolderPicker,
      ),
      _MoreSheetItem(
        icon: CupertinoIcons.search_circle,
        title: 'Quick Switcher',
        subtitle: 'Cambiar rÃ¡pido con Ctrl/Cmd+K',
        onSelected: _openQuickSwitcher,
      ),
      _MoreSheetItem(
        icon: CupertinoIcons.sort_down,
        title: 'Ordenar',
        subtitle: 'Recientes, tÃ­tulo o cantidad de filas',
      ...
      _MoreSheetItem(
        ...
        title: 'Premium',
        subtitle: 'Planes, alcance y activaciÃ³n comercial',
      ...
      _MoreSheetItem(
        ...
        title: 'Privacidad',
        subtitle: 'PolÃ­tica de uso y tratamiento de datos',
      ...
      _MoreSheetItem(
        ...
        title: 'Licencias',
        subtitle: 'CrÃ©ditos de librerÃ­as de terceros',
  ...
  Future<void> _openQuickSwitcher() async {
    ...
    for (final sheet in _activeSheets) {
      final title =
          sheet.title.trim().isEmpty ? 'Planilla sin tÃ­tulo' : sheet.title;
      final suffix = _isFavoriteSheet(sheet.id) ? ' Â· Favorita' : '';
      actions.add(
        CommandAction(
          id: 'quick_sheet_${sheet.id}',
          label: title,
          subtitle: 'Planilla$suffix Â· ${_fmt(sheet.updatedAt)}',
    ...
    actions.addAll([
      CommandAction(
        ...
        subtitle: 'Crear planilla vacÃ­a',
      ...
      CommandAction(
        ...
        subtitle: 'Abrir galerÃ­a de templates',
    ...
    for (final template in _commercialTemplates) {
      actions.add(
        CommandAction(
          ...
          label: template.name,
          subtitle: 'Template Â· ${template.pack}',
          icon: template.icon,
  ...
  Widget build(BuildContext context) {
    ...
    final startupErrors = <String>[
      ...
      if ((_orgLoadError ?? '').trim().isNotEmpty)
        'OrganizaciÃ³n: ${_orgLoadError!.trim()}',
    ];
              ...
              CustomScrollView(
                ...
                slivers: [
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        _tab == _HomeTab.trash
                                            ...
                                            : 'Planillas claras para trabajar todos los dÃ­as.',
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                            ...
                            if (_tab == _HomeTab.sheets) ...[
                              ...
                              const SizedBox(height: 8),
                              Text(
                                'Ctrl/Cmd+K para cambiar rÃ¡pido',
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: AppErrorState(
                          ...
                          message:
                              'BitFlow continuÃ³ con configuraciÃ³n segura para evitar bloquear el inicio.',
                  ...
                  if (data.isEmpty)
                    ...
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(16, 0, 16, 170 + bottomPad),
...
class _DashboardQuickSections extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final emptyMessage = activeTab == _DailyFocusTab.recents
        ? 'TodavÃ­a no hay planillas recientes.'
        : 'TodavÃ­a no hay planillas favoritas.';
...
class _DashboardQuickRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final title =
        meta.title.trim().isEmpty ? 'Planilla sin tÃ­tulo' : meta.title;
    return CupertinoButton(
...
class _TemplateSearchResults extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (templates.isEmpty) {
      return Text(
        'Sin plantillas para esta bÃºsqueda.',
        style: TextStyle(
          color: colors.textSecondary,
          fontSize: 12,
          fontWeight: FontWeight.w600,
          ...
          CupertinoButton(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    '${templates[i].name} Â· ${templates[i].pack}',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: colors.textSecondary,
      ...
      child: Column(
        ...
        children: [
          _DisclosureRow(
            ...
            title: 'Pro',
            subtitle: 'VersiÃ³n $releaseVersion',
          ...
          if (proExpanded) ...[
            const SizedBox(height: 8),
            Text(
              'Entrega profesional con menos fricciÃ³n operativa.',
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(
                color: colors.textSecondary,
      ...
      child: Column(
        children: [
          ...
          if (tab == _HomeTab.sheets)
            Text(
              'Inicio rÃ¡pido: Crear planilla -> completar filas -> Exportar ZIP.',
              textAlign: TextAlign.center,
              style: TextStyle(
                color: colors.textSecondary,
                fontSize: 12,
