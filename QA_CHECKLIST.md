...
- Exportar **Backup ZIP**: debe contener `backup.json` + `attachments/`.
- Exportar **Reporte HTML**: abrir en navegador y probar **Imprimir / Guardar PDF**.
- Importar backup ZIP desde **Home > Opciones** y verificar adjuntos rehidratados.
